...
class TestHistoryManagement:
    ...
    def test_merge_transcript_into_existing_audio_message(self):
        ...
        new_history = RealtimeSession._get_new_history(cast(list[RealtimeItem], old_history), transcription_event)
        ...
        assert cast(InputAudio, updated_item.content[1]).audio == "audio_data"  # Should preserve audio data
    ...
    def test_update_existing_item_by_id(self):
        ...
        new_history = RealtimeSession._get_new_history(cast(list[RealtimeItem], old_history), updated_item)
    ...
    def test_update_existing_item_preserves_order(self):
        ...
        new_history = RealtimeSession._get_new_history(cast(list[RealtimeItem], old_history), updated_item2)
    ...
    def test_insert_new_item_after_previous_item(self):
        ...
        new_history = RealtimeSession._get_new_history(cast(list[RealtimeItem], old_history), new_item)
