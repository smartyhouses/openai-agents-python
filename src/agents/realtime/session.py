...
class RealtimeSession(RealtimeModelListener):
    ...
    async def enter(self) -> "RealtimeSession":
        ...
        pattern instead of this method. If you use this, you need to manually call `close()` when you
        are done.
        """
    ...
    async def on_event(self, event: RealtimeModelEvent) -> None:
        await self._put_event(RealtimeRawTransportEvent(data=event, info=self._event_info))
